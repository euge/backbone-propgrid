var Propgrid = Backbone.View.extend({
  ...
  render : function() {
    ...
    for (i = 0, l = attrs.length; i < l; ++i) {
      itemView = new Propgrid.Item({ model : this.model, attr : attrs[i] });
...
Propgrid.Item = Backbone.View.extend({
  ...
  render : function() {
    this.$el.append("<td class='propgrid-attr-name'>" + this.options.attr + "</td><td class='propgrid-attr-value'></td>");
    this.$(".propgrid-attr-value").
